...
<span class='key_d'></span> کلید  برای این کار، لطفا انگشت اشاره دست چپ خود را روی
و انگشت اشاره دست راست خود را روی کلید <span class='key_k'></span>  
صفحه کلید خود قرار دهید.
<br /><br />
در هر اجرا، یک مربع سیاه در مرکز صفحه ظاهر می شود. لطفا به این مربع نگاه کنید. به زودی با یک عدد جایگزین خواهد شد
<br /><br />
اگر عدد فرد (۱و۳و۷و۹) <span class='nums_d'></span> است،
<span class='key_d'></span>را فشار دهید<br />.
اگر عدد زوج (۲و۴و۶و۸) <span class='nums_ k'></span> است،
<span class='key_ k'></span>را فشار دهید</b> <br /><br />.
لطفا تا جایی که می توانید سریع و دقیق پاسخ دهید
آزمایش با یک تمرین شروع می شود، در ضمن تمرین در مورد صحت پاسخ های خود بازخورد دریافت خواهید کرد.
<br /><br />
برای شروع،<span class='key_d'></span> or <span class='key_k'></span>
...
<br /><br />
اگر عدد زوج (۲و۴و۶و۸)<span class='nums_d'></span> است،
<span class='key_d'></span>را فشار دهید<br />.
اگر عدد فرد (۱و۳و۷و۹)<span class='nums_ k'></span> است،
<span class='key_ k'></span>را فشار دهید</b> <br /><br />.
...
<br /><br />`,
    ...
    block_text_mag:
        ...
        // BLOCK 1:
        // Instruction Screen (before practice session)
        [/*html*/ `<br /> در این آزمایش از شما خواسته می شود پاسخ دهید اعدادی که می بینید از عدد ۵ کوچکتر هستند یا بزرگتر </b>.<br /><br />
<span class='key_d'></span> کلید  برای این کار، لطفا انگشت اشاره دست چپ خود را روی
و انگشت اشاره دست راست خود را روی کلید <span class='key_k'></span>  
صفحه کلید خود قرار دهید. <br /><br />
در هر اجرا، یک مربع سیاه در مرکز صفحه ظاهر می شود. لطفا به این مربع نگاه کنید. به زودی با یک عدد جایگزین خواهد شد.<br /><br />
اگر عدد کوچکتر از ۵) ۱،۲،۳،۴(   <span class='nums_d'></span> است،
<span class='key_d'></span>را فشار دهید<br />.
اگر عدد بزرگتر از ۵) ۶،۷،۸،۹ (  <span class='nums_ k'></span> است،
<span class='key_ k'></span>را فشار دهید</b> <br /><br />.
لطفا تا جایی که می توانید سریع و دقیق پاسخ دهید
آزمایش با یک تمرین شروع می شود، در ضمن تمرین در مورد صحت پاسخ های خود بازخورد دریافت خواهید کرد.
<br /><br />
...
<br /><br />`,
    ...
    // BLOCK 2:
    // Instruction Screen (before second practice session):
    /*html*/ `<br />در نیمه دوم، تکلیف شما همچنان این ست که اعداد را به کوچکتر یا بزرگتر از ۵ طبقه بندی کنید.
</b>.
نکته مهم این است که اکنون کلیدهای پاسخ به کوچکتر یا بزرگتر بودن اعداد معکوس خواهد شد. <b>
<br /><br />
اگر عدد بزرگتر از ۵) ۶،۷،۸،۹ (  <span class='nums_ d'></span> است،
<span class='key_ d'></span>را فشار دهید</b> <br /><br />.
اگر عدد کوچکتر از ۵) ۱،۲،۳،۴(   <span class='nums_ k'></span> است،
<span class='key_ k'></span>را فشار دهید<br />.
لطفا تا جایی که می توانید سریع و دقیق پاسخ دهید <br /><br />
مجدداً یک جلسه تمرین وجود خواهد داشت که در آن بازخوردی در مورد صحت پاسخ های خود دریافت خواهید کرد.
<br />
برای شروع،<span class='key_d'></span> or <span class='key_k'></span>
